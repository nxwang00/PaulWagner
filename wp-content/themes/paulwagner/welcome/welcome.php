	...
	class WP_Store_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					//'actions_required' => esc_html__('Required Plugins', 'wp-store'),
			...
			public function welcome_admin_notice_display(){
				...
				$wp_store_an_style = '
				.wp-store-an.notice.is-dismissible {padding: 20px 15px 5px;}
				.wp-store-an hr {margin: 20px -23px 0;border-top: 1px solid #f3f4f5;border-bottom: none;}
				.wp-store-an h3{margin: 17px 0 0;font-size: 16px;line-height: 1.4;}
				.wp-store-an p {color: #72777c;}
				.wp-store-an h2{margin: 0;font-size: 21px;font-weight: 400;line-height: 1.2;}
				.wp-store-an p.about-desc{color: #72777c;font-size: 16px;margin: 0;padding:0px;}
				.wp-store-column-wrap {display: -ms-grid;display: grid;-ms-grid-columns: 24% 32% 32%;grid-template-columns: 24% 32% 32%;margin-bottom: 13px;}
				.wp-store-column {padding: 20px 40px 0 0;}
				.wp-store-an .wp-store-btn {padding: 30px;line-height: 0;}';
