        ...
        <tr>
            <td align="center">
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td><center><img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/logo.png" alt="" style="display:block;margin:0;" /></center></td>
                    </tr>
                </table>
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td><center><img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/banner.jpg" alt="" style="display:block;margin:0;" /></center></td>
                    </tr>
                </table>
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td colspan="4" style="color:#162f5d;font-size:22px;font-weight:700;padding:5px;padding-bottom:10px;">Your Information:</td>
                    </tr>
                    <tr>
                        ...
                        <td style="color:#162f5d;font-size:15px;font-weight:700;padding:5px;vertical-align:top;border-bottom:1px solid #dddff3;">Address</td>
                        ...
                        <td>
                            <table align="center" class="itmes_in" border="0" cellspacing="0" cellpadding="5px" width="100%" style="vertical-align:top;padding:0;color:#162f5d;font-size:15px;font-weight:700;">
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="color:#b40aca;font-size:15px;font-weight:700;width:90px;">$ <?php echo $total; ?></td>
                                </tr>          
                ...
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    ...
                    <tr>
                        <td>
                            <table align="right" class="subtotal_in" border="0" cellspacing="0" cellpadding="3px" width="300" style="vertical-align:top;padding:0;">
                                <tr>
                                    <th align="right" style="color:#162f5d;font-size:15px;font-weight:400;text-align:right;padding-right:20px;">Subtotal:</th>
                                    <th align="left" style="color:#162f5d;font-size:15px;font-weight:400;text-align:left;">$ 
                                        <?php echo $order->get_subtotal(); ?></th>
                                </tr>
                                <tr>
                                    <th align="right" style="color:#162f5d;font-size:15px;font-weight:400;text-align:right;padding-right:20px;">
                                        Shipping
                                    :</th>
                                    <th align="left" style="color:#162f5d;font-size:15px;font-weight:400;text-align:left;">$ 
                                ...
                                <tr>
                                    ...
                                    <th align="left" style="color:#162f5d;font-size:15px;font-weight:400;text-align:left;">$ <?php echo round($order->get_total_tax(),2) ?></th>
                                </tr>
                                <tr style="color:#b40aca;">
                                    <th align="right" style="color:#b40aca;font-size:15px;font-weight:400;text-align:right;padding-right:20px;">Order Total:</th>
                                    <th align="left" style="color:#b40aca;font-size:15px;font-weight:400;text-align:left;">$ <?php echo $order->get_total();?></th>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td><center><img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/yourspecialoffer.jpg" alt="" style="display:block;margin:0;width:100%;" /></center></td>
                    </tr>
                </table>
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                            ...
                            <table align="center" class="offer_in" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding:0;color:#004f63;">
                                <tr>
                                    <td align="left" style="width:40%;text-align:left;color:#ffffff;line-height:0;">
                                        <img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/personalitycards.png" alt="" style="display:inline-block;margin:0;" />
                                    </td>
                                    <td align="right" style="width:60%;padding-right:60px;text-align:right;">
                                        <h2 style="color:#3f2589;font-size:24px;font-weight:700;line-height:28px;text-align:right;padding:0 0 15px 0;margin:0;">THE PERSONALITY CARDS:<br>Inspiration for Life,<br>Love & Relationships</h2>
                                        <p style="color:#692567;font-size:16px;font-weight:500;line-height:20px;text-align:right;padding:0 0 20px 0;margin:0;">The Personality Cards is a unique and wonderful oracle, akin to tarot, but far more powerful and insightful. Included in the purchase are 78 beautifully illustrated cards and a 174-page booklet, inside of a luxurious box.</p>
                                        <p style="text-align:right;display:inline-block;padding:0;margin:0;width:255px;"><a href="https://www.paulwagner.com/product/the-personality-cards-divine-inspiration-for-life-love-relationships/" style="color:#ececec;font-size:14px;font-weight:500;line-height:16px;text-decoration:none;text-align:center;display:block;background:#8a007f;border:none;padding:8px 20px;width:100%;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">Check Out The Personality Cards!</a></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table align="center" class="offer_in" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding:0;color:#004f63;">
                                <tr><td align="left" style="width:60%;padding-left:60px;text-align:left;">
                                        <h2 style="color:#3f258a;font-size:24px;font-weight:700;line-height:28px;text-align:left;padding:0 0 15px 0;margin:0;">INTUITIVE READING<br/>WITH PAUL</h2>
                                        <p style="color:#692567;font-size:16px;font-weight:500;line-height:20px;text-align:left;padding:0 0 20px 0;margin:0;">Find the answers you need to improve your life,conditions, and relationships. Improve your future with this deep-drive into your gifts, talents, and attributes.</p>
                                        <p style="text-align:right;display:inline-block;padding:0;margin:0;width:255px;"><a href="https://www.paulwagner.com/product/one-hour-session/" style="color:#ececec;font-size:14px;font-weight:600;line-height:16px;text-decoration:none;text-align:center;display:block;background:#8a007f;border:none;padding:8px 20px;width:100%;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">Get Some Love</a></p>
                                    </td>
                                    <td align="right" style="width:40%;text-align:right;color:#ffffff;line-height:0;">
                                        <img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/paulcards.png" alt="" style="display:inline-block;margin:0;" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table align="center" class="order" border="0" cellspacing="0" cellpadding="0" width="460" style="vertical-align:top;padding:0;width:240px;">
                                <tr>
                                    <td align="center"><a href="https://www.facebook.com/personalitiesbook"><img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/fb.png" alt="" style="display:inline-block;margin:0;" /></a></td>
                                    <td align="center"><a href="https://twitter.com/playfulstorm"><img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/twitt.png" alt="" style="display:inline-block;margin:0;" /></a></td>
                                    <td align="center"><a href="https://www.linkedin.com/in/peacefulgeek/"><img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/linkedin.png" alt="" style="display:inline-block;margin:0;" /></a></td>
                                    <td align="center"><a href="https://www.instagram.com/peacefulgeek/"><img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/insta.png" alt="" style="display:inline-block;margin:0;" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table align="center" class="order" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding:20px;background:#37298d;width:100%;">
                    <tr>
                        <td align="center">
                            <p style="color:#ffffff;font-size:20px;font-weight:400;line-height:22px;text-align:center;padding:0;margin:0;"><strong style="color:#ffffff;font-weight:400;padding-right:6px;position:relative;top:-4px;">Made for you with</strong> <img src="https://www.paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/redheart.png" alt="" style="display:inline-block;margin:0;" /></p>
                        </td>
                    </tr>
                </table>
            </td>
