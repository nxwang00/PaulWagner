        ...
        <tr>
            <td align="center">
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td><center><img src="<?php the_field('logo', 'option'); ?>" alt="" style="display:block;margin:0;" /></center></td>
                    </tr>
                </table>
<!-- 
                 <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td><center>If you are booking a session with Paul, please review the <a href="https://www.paulwagner.com/consent-and-waiver/">Consent & Waiver Agreement</a> prior to your appointment. </center></td>
                    </tr>
                </table> -->
                ...
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td><center><img src="<?php the_field('banner_image_send_mail', 'option'); ?>" alt="" style="display:block;margin:0;" /></center></td>
                    </tr>
                </table>
                ...
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td colspan="2" style="color:#162f5d;font-size:15px;font-weight:400;padding-bottom:10px;border-top:1px solid #dddff3;"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="vertical-align:middle;padding-left:15px;padding-bottom:20px;width:250px;">
                            <p style="font-size:14px;line-height:20px;display:inline-block;vertical-align:top;margin:0;"><img style="display:inline-block;position:relative;top:0;" src="https://paulwagner.com/wp-content/themes/paulwagner/woocommerce/img/greentick.png" alt=""></p><a style="color:#000;font-size:16px;font-weight:400;line-height:20px;text-decoration:none;display:inline-block;border-bottom:1px solid #000;margin-left:0;" target="_blank" href="https://www.paulwagner.com/consent-and-waiver/">Customer Agreed to <br>Consent & Waiver</a>
                        </td>
                ...
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                        <td><center><img src="<?php the_field('your_special_gift', 'option'); ?>" alt="" style="display:block;margin:0;width:100%;" /></center></td>
                    </tr>
                </table>
                <table align="center" class="header" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding-top:30px;padding-bottom:25px;width:100%;">
                    <tr>
                            ...
                            <table align="center" class="offer_in" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding:0;color:#004f63;">
                                <tr>
                                    <td align="left" style="width:40%;text-align:left;color:#ffffff;line-height:0;">
                                        <img src="<?php the_field('left_side_image', 'option'); ?>" alt="" style="display:inline-block;margin:0;" />
                                    </td>
                                    <td align="right" style="width:60%;padding-right:60px;text-align:right;">
                                       
                                        <?php the_field('right_content', 'option'); ?>

                                        <p style="text-align:right;display:inline-block;padding:0;margin:0;width:255px;">

                                      


                                            <a href="<?php the_field('button_url', 'option'); ?>" style="color:#ececec;font-size:15px;font-weight:600;line-height:18px;text-decoration:none;text-align:center;display:block;background:#8a007f;border:none;border-radius:7px;-moz-border-radius:7px;-webkit-border-radius:7px;padding:8px;width:100%;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;"><?php the_field('button_text', 'option'); ?></a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table align="center" class="offer_in" border="0" cellspacing="0" cellpadding="0" width="100%" style="vertical-align:top;padding:0;color:#004f63;">
                                <tr><td align="left" style="width:60%;padding-left:60px;text-align:left;">
                                    ...
                                    <td align="right" style="width:40%;text-align:right;color:#ffffff;line-height:0;">
                                        <img src="<?php the_field('right_side_image', 'option'); ?>" alt="" style="display:inline-block;margin:0;" />
                                    </td>
                                </tr>
                            </table>
                        </td>
