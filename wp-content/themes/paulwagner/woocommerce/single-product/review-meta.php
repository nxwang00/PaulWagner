...
<?php } else { ?>
	...
	<p class="meta">
		...
		if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
			...
			$verified_owner = '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'woocommerce' ) . ')</em> ';
		}

		?>
		<span class="woocommerce-review__dash">&ndash;</span> <time class="woocommerce-review__published-date" datetime="<?php echo $randomDate ; ?>"><?php echo $randomDate ; ?></time><span class="vf_own"><img src="<?php echo site_url(); ?>/wp-content/themes/paulwagner/images/tick.png"></span>
	</p>
