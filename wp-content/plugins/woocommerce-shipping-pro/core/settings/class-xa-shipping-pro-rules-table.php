...
class xa_sp_rules_table extends WP_List_Table {
	...
	function get_columns(){
		$all = array(
			...
			'city'			=> 'City <span class="xa-tooltip"><img src="'.site_url('/wp-content/plugins/woocommerce/assets/images/help.png').'" height="16" width="16" /><span class="xa-tooltiptext">Enter name of the city for which this rule should be applicable. Leave it blank to apply this rule for all the cities.</span></span>',
