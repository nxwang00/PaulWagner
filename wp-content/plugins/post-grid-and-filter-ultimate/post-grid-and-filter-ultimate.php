...
if( ! defined( 'PGAFU_VERSION' ) ) {
	define( 'PGAFU_VERSION', '1.4.5' ); // Version of plugin
}
...
if( ! defined( 'PGAFU_PLUGIN_BUNDLE_LINK' ) ) {
    define('PGAFU_PLUGIN_BUNDLE_LINK','https://www.essentialplugin.com/wordpress-plugin/post-grid-filter-ultimate/?utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=Bundle-Banner#wpos-epb'); // Plugin link
}

if( ! defined( 'PGAFU_PLUGIN_LINK_UNLOCK' ) ) {
    define('PGAFU_PLUGIN_LINK_UNLOCK','https://www.essentialplugin.com/wordpress-plugin/post-grid-filter-ultimate/?utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=Features-PRO'); // Plugin link
}

if( ! defined( 'PGAFU_PLUGIN_LINK_UPGRADE' ) ) {
    define('PGAFU_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/post-grid-filter-ultimate/?utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=Upgrade-PRO'); // Plugin Check link
}
