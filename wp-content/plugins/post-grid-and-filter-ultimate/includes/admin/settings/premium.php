...
<div class="wrap">
	...
	<h2><?php _e( 'Post grid and filter ultimate with ', 'post-grid-and-filter-ultimate' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'post-grid-and-filter-ultimate' ); ?></span></h2><br />
		...
		<div id="post-body" class="metabox-holder columns-2">
				...
				<table class="wpos-plugin-pricing-table">
					...
					<colgroup></colgroup>
						...
						<tr>
							...
							<th>
								...
								<a href="<?php echo PGAFU_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
							</th>
						</tr>
					</thead>
					...
					<tfoot>
						<tr>
							...
							<a href="<?php echo PGAFU_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
					<tbody>
						<tr>
			...
			<div id="postbox-container-1" class="postbox-container wpos-sidebar">
				<div class="wpos-epb-wrap">
					...
					<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo PGAFU_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
				</div>
