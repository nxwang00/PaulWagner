<?php
/**
 * Plugin Name:       WooCommerce Minicart
 ...
 */
define( 'WOO_MINICART_VERSION', '2.0.3' );
...
function wmc_no_woocommerce(){ ?>
		<div class="error">
				<p><?php _e( 'WooCommerce Minicart Plugin is activated but not effective. It requires WooCommerce in order to work.', 'woo-minicart' ); ?></p>
			</div>
<?php	
}
