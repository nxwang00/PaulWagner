...
class Autoloader {
     ...
     * @access private
     * @static
     * @var    array Classes array use by GS Testimonial.
     */
     ...
     * @static
     * 
     * Classes folder used for @package GS Testimonial.
     */
    private static $SOURCE_DIRECTORY = GST_PLUGIN_DIR;
     ...
     * @static
     * 
     * Classes array used for @package GS Testimonial.
     */
