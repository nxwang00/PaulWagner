...
function gs_testimonial_meta_box_callback( $post ) {
	...
	<p><input class="large-text" type="text" name="gs_t_client_company" id="gs_t_client_company" value="<?php echo esc_attr( get_post_meta($post->ID, 'gs_t_client_company', true) ); ?>" /></p>

	<p><label for="gs_t_client_design"><b><?php _e('Designation:', 'gst'); ?></b></label></p>
	<p><input class="large-text" type="text" name="gs_t_client_design" id="gs_t_client_design" value="<?php echo esc_attr( get_post_meta($post->ID, 'gs_t_client_design', true) ); ?>" /></p>
