							...
							<div id="postbox-container-2" class="postbox-container">
								<div id="advanced" class="meta-box-sortables">
									<div id="gs_plugins_free" class="postbox" >
										...
										<h2 class="hndle"><?php _e( 'GS Plugins - recommended more free plugins', 'gst' ); ?></h2>
										<div class="inside">
																	...
																	if ( current_user_can( "install_plugins" ) || current_user_can( "update_plugins" ) ) {
																		...
																		switch ( $status["status"] ) {
																			case "install":
																				if ( $status["url"] ) {
																					/* translators: 1: Plugin name and version. */
																					$action_links[] = '<a class="install-now button" href="' . esc_url($status['url']) . '" aria-label="' . esc_attr( sprintf("Install %s now", $name ) ) . '">' . __( 'Install Now', 'gst' ) . '</a>';
																				}
																			break;
																	...
																	<div class="plugin-div plugin-div-settings">
																		<div class="plugin-div-top plugin-div-settings-top">
																			<div class="plugin-div-inner-content">
																				...
																				<div class="desc column-description">
																					...
																					<p class="authors">
																						<cite>
																							<?php _e( 'By', 'gst' ); ?> <?php echo wp_kses_post( $author );?>
																						</cite>
																					</p>
																				</div>
																			</div>
																			<div class="action-links">
																				<ul class="plugin-action-buttons-custom">
																					<li>
																						<?php
																							if ( $action_links ) {
																								echo wp_kses_post( implode( "</li><li>", $action_links ) );
																							}
																						?>
																					</li>
																				</ul>
																		...
																		<div class="plugin-card-bottom plugin-card-bottom_settings">
																			...
																			<div class="column-updated">
																				<strong><?php _e( 'Last Updated:', 'gst' ); ?></strong> <span title="<?php echo esc_attr($plugin["last_updated"]); ?>">
